function calcularDesconto(calcularTotal){
 ...
 const precoCadeiraGamer = 650;

 //
 const precoSmartphoneLucas = 1;
 const tabletlucas = 1;
...
console.log("Total de compras de Lucas", totalLeilaComDesconto.toFixed(2));
...
function calcular(){
  ...
  document.getElementById("total").innerHTML = "valortotal: " + valorTotalTotal(bovis, porc,frango, linguiças);
  document.getElementById("desconto").innerHTML = "AplicarDesconto: " + AplicarDesconto (valorTotal (bovis, porc,frango, linguiças));
